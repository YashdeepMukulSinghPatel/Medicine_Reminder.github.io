...
const MessagingDashboard = () => {
  ...
  const fetchMessages = () => {
    axios.get(`https://reminderpillapp.onrender.com/getAllMessages?limit=${messagesPerPage}&pages=${currentPage}`)
    .then(response => {
  ...
  const handleDelete = (index) => {
    axios.post("https://reminderpillapp.onrender.com/deleteMessage",{MessageSid : messages[index].MessageSid})
    .then(response => {
  ...
  const handleSearchMessages = (event) => {
    ...
    axios.get(`https://reminderpillapp.onrender.com/getMessageByPhone?phoneNumber=${encodedPhoneNumber}&limit=${messagesPerPage}&pages=${currentPage}`)
    .then(response => {
        if(response.data.message === "Retrieved Data"){
            setTotalMessages(response.data.totalLength);
            setMessages(response.data.arrayList);
