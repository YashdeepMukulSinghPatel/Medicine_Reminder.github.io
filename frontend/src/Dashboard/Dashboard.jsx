...
const Dashboard = () => {
  ...
  const fetchPatients = () => {
    axios.get(`https://reminderpillapp.onrender.com/getAllUsers?limit=${patientsPerPage}&pages=${currentPage}`)
    .then(response => {
  ...
  const searchPatients = async () => {
    const res = await axios.get(`https://reminderpillapp.onrender.com/searchByUserName?name=${searchText}&limit=${patientsPerPage}&pages=${currentPage}`);
